...
var _cartActions = __webpack_require__(50);
...
var _booksLists = __webpack_require__(55);

var _booksLists2 = _interopRequireDefault(_booksLists);
...
(0, _reactDom.render)(_react2.default.createElement(
	...
	{ store: store },
	_react2.default.createElement(_booksLists2.default, null)
...
*/
var aa=__webpack_require__(5),l=__webpack_require__(15),B=__webpack_require__(2),C=__webpack_require__(1),ba=__webpack_require__(16),da=__webpack_require__(17),ea=__webpack_require__(18),fa=__webpack_require__(19),ia=__webpack_require__(20),D=__webpack_require__(3);
...
var _booksReducers = __webpack_require__(53);

var _cartReducers = __webpack_require__(54);
...
function booksReducers() {
	...
	switch (action.type) {
		...
		case "DELETE_BOOK":
			{
				...
				var currBook = [].concat(_toConsumableArray(state.books));
				console.log(action.payload.id);
				//determine book deleted
				var newArray = currBook.filter(function (e) {
		...
		case "UPDATE_BOOK":
			{
				// create a copy of array of books
				var _currBook = [].concat(_toConsumableArray(state.books));
				//determine book deleted
				_currBook.map(function (item, index) {
...
function cartReducers() {
	...
	switch (action.type) {
		case "ADD_TO_CART":
			{
				return [].concat(_toConsumableArray(state.cart), _toConsumableArray(action.payload));
			}
	}
	return state;
}
